...
with open('src/classificator/tfidf_vectorizer.pkl', 'rb') as file:
...
pipeline = Pipeline([
    ...
    ('prediction', XGBoostClassifier('src/classificator/xgboost_model.pkl'))
])
...
data_new = pd.read_csv("data/newly_fetched_data.csv")
